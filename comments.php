	...
	<?php if ( have_comments() ) : ?>
		...
		<ol class="commentlist">
			<?php
				 ...
				 * to use school_comment() to format the comments.
				 * If you want to overload this in a child theme then you can
				 * define school_comment() and that will be used instead.
				 * See school_comment() in inc/template-tags.php for more.
				 */
				wp_list_comments( array( 'callback' => 'school_comment' ) );
			?>
		</ol><!-- .commentlist -->
